...
# #  py_script = 'C:/Users/ga25mal/00_Work/02_python/b2h_headless.py'
# #  exec(compile(open(py_script).read(), py_script, 'exec'))
# exec(compile(open('C:/Users/ga25mal/00_Work/02_python/b2h_headless.py').read(), 'C:/Users/ga25mal/00_Work/02_python/b2h_headless.py', 'exec'))
###
import os
import math
import bpy
...
helios_path = '/var/lib/dockervol/helios_lean/'
